...
Таким образом, Monte Carlo и Importance Sampling не являются двумя разными моделями риска. Они должны оценивать один и тот же VaR. Разница заключается в численной эффективности при оценке хвостового квантиля.
## Модели доходностей
